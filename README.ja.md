...
Vpage(1)に相当するビデオ制御を使用します。特定機種のスーパーインポーズ
アダプターには依存しません。
...
- 外部コンポジット映像をX68000のビデオ経路へ入力できるハードウェア
- 同期した外部コンポジット映像ソース
- 合成後のX68000 RGB信号に対応する表示装置またはコンバーター
